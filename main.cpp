...
namespace ShaderData
{
    ...
    namespace Shaders
    {
        #define SHADER_CS_BEGIN(NAME, FILENAME, ENTRY) CComputeShader NAME;
        #define SHADER_VSPS_BEGIN(NAME, FILENAME, VSENTRY, PSENTRY, VERTEXFORMAT) CShader NAME;
        #include "ShaderTypesList.h"
    };
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                ShaderData::Shaders::IMGUI.Draw(g_d3d.Context(), pcmd->ElemCount, idx_offset, vtx_offset);
            }
...
{
    // TODO: temp!
    ShaderData::Shaders::EStaticBranches_VSPS_showPathTrace::SBGrey;
    ...
    // TODO: need to write a static branches file per permutation, and need to compile each permutation!

    // create shaders
    #define SHADER_CS_BEGIN(NAME, FILENAME, ENTRY) \
    { \
        static_assert((uint32_t)ShaderData::Shaders::EStaticBranches_CS_##NAME::COUNT <= 32, "Too many static branches in CS shader: "#NAME); \
        ShaderData::WriteStaticBranches_CS_##NAME(); \
    ...
    { \
        ...
        ShaderData::WriteStaticBranches_VSPS_##NAME(); \
